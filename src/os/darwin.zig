...
pub extern "c" fn __ulock_wait(operation: u32, addr: ?*anyopaque, value: u64, timeout_us: u32) c_int;
pub extern "c" fn __ulock_wake(operation: u32, addr: ?*anyopaque, wake_value: u64) c_int;
