...
pub fn submit(self: *Self, state: *LoopState, c: *Completion) void {
    ...
    switch (c.op) {
        ...
        .file_open, .file_create, .file_close, .file_read, .file_write, .file_sync, .file_size, .file_set_size, .file_set_permissions, .file_set_owner, .file_set_timestamps, .file_stat, .dir_open, .dir_close, .dir_create_dir, .dir_rename, .dir_delete_file, .dir_delete_dir => unreachable,
    }
}
